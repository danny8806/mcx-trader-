...
- **test_id**: clm-20260906-120045
- **git commit**: b932ef051d1294d317d254312950583bee742e88
- **started**: 2026-09-06T12:01:55+05:30
...
- **Q13 token lifecycle checked?** - expiry={'expires_at': 1788015978, 'remaining_hours': -183.40764471464686, 'expires_soon': True} renewal=PIN/TOTP absent -> token-file only
...
- failures: 4
  ...
  - test-session record not persisted to canonical DB
  - reconnect verification failed
  - crash-kid simulation did not die mid-transaction
- phases with exceptions: ['db_persistence_probe', 'session_end_evidence']
