...
- **test_id**: clm-20260906-132623
- **git commit**: b932ef051d1294d317d254312950583bee742e88
- **started**: 2026-09-06T14:01:08+05:30
...
- **Q8 DB == memory reconciliation?** - yes (98 checks)
- **Q9 API == DB reconciliation?** - 131 health samples; see SOAK.json api_samples
...
- **Q13 token lifecycle checked?** - expiry={'expires_at': 1788767893, 'remaining_hours': 23.99929308520423, 'expires_soon': False} renewal=PIN/TOTP absent -> token-file only
...
- **Q19 test terminates?** - duration_minutes=30.0 with finite phase timeouts
...
## Failures / Errors
- failures: 17
  - GOLDM 5: 811 OHLC anomalies
  - GOLDM 15: 285 OHLC anomalies
  - GOLDM 60: 73 OHLC anomalies
  - SILVERM 5: 809 OHLC anomalies
  - SILVERM 15: 280 OHLC anomalies
  - SILVERM 60: 75 OHLC anomalies
