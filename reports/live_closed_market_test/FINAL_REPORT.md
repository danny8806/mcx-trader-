...
- **test_id**: clm-20260906-122356
- **git commit**: b932ef051d1294d317d254312950583bee742e88
- **started**: 2026-09-06T13:01:05+05:30
...
- **Q8 DB == memory reconciliation?** - yes (92 checks)
- **Q9 API == DB reconciliation?** - 122 health samples; see SOAK.json api_samples
...
- **Q13 token lifecycle checked?** - expiry={'expires_at': 1788015978, 'remaining_hours': -183.82453335689175, 'expires_soon': True} renewal=PIN/TOTP absent -> token-file only
