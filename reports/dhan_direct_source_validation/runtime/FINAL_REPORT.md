...
- **test_id**: clm-20260906-144847
- **git commit**: b932ef051d1294d317d254312950583bee742e88
- **started**: 2026-09-06T15:23:09+05:30
...
- **Q8 DB == memory reconciliation?** - yes (97 checks)
- **Q9 API == DB reconciliation?** - 129 health samples; see SOAK.json api_samples
...
- **Q13 token lifecycle checked?** - expiry={'expires_at': 1788772839, 'remaining_hours': 23.999409234788683, 'expires_soon': False} renewal=PIN/TOTP absent -> token-file only
