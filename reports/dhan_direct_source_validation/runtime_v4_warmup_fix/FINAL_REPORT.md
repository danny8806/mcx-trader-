...
- **test_id**: clm-20260906-162144
- **git commit**: b932ef051d1294d317d254312950583bee742e88
- **started**: 2026-09-06T16:27:05+05:30
...
- **Q8 DB == memory reconciliation?** - yes (10 checks)
- **Q9 API == DB reconciliation?** - 13 health samples; see SOAK.json api_samples
...
- **Q13 token lifecycle checked?** - expiry={'expires_at': 1788778417, 'remaining_hours': 23.99941000978152, 'expires_soon': False} renewal=PIN/TOTP absent -> token-file only
...
## Failures / Errors
- failures: 0
- phases with exceptions: ['indicator_audit']
